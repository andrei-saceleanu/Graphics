...
void Lab5::Update(float deltaTimeSeconds)
{
    ...
    // implemented, and the local projection matrix.
    {
        ...
        modelMatrix = glm::rotate(modelMatrix, RADIANS(60.f), glm::vec3(1.f, 0, 1.f));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.3f, 0.6f, 0.3f));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
    }
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(2.f, 2.7f, 2.f));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(120.f), glm::vec3(0.7f, 0.2f, 0.5f));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.7f, 1.f, 0.7f));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
    }
